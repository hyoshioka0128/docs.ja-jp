---
title: 演算子 '<operatorsymbol>' は、すべてのコードのパスでは値を返しません。
ms.date: 07/20/2015
f1_keywords:
- vbc42106
- bc42106
...
---
# <a name="operator-operatorsymbol-doesnt-return-a-value-on-all-code-paths"></a>演算子 '\<operatorsymbol >' は、すべてのコードのパスでは値を返しません。
